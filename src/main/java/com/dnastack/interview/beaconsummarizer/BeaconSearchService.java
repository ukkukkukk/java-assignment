...
public class BeaconSearchService {
    ...
    public BeaconSummary beaconSearchSummary(String ref, String chrom, String pos, String allele) throws Exception
    {
        ...
        //get beacon details
        List<BeaconDetail> beaconDetails = getBeaconDetailsInBatches(beaconIds, ref, chrom, pos, allele, BATCH_SIZE);
